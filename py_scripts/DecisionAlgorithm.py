...
class DecisionTreeRegressionTraining():
    ...
    def __init__(self, criterion, max_tree_depth, rf_seed, input, target):
    ...
    def __call__(self):
        regressor = DecisionTreeRegressor(criterion=self.criterion,
...
class  DecisionTreeRegressionTesting():
